...
class _FoodScreenState extends State<FoodScreen> {
  ...
  Future<void> fetchFoodDetails() async {
    List<ViewFoodModel> data = await FoodViewAPI.getFoodItems(widget.id);
    setState(() {
      _foodView = data;
      print(_foodView);
    });
  ...
  Widget build(BuildContext context) {
    ...
    final double itemHeight = (size.height - kToolbarHeight - 200) / 1.82;
